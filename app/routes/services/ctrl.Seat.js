var User = require('../../modules/database/db.User.js');

module.exports = {
    init: function(app) {
        app.get('/user/login', this.doLoginIn);
        app.post('/user/changePwd', this.doChangePwd);
        app.post('/user/changeInfo', this.doChangeInfo);
        app.get('/user/get', this.doGetAllUser);
        app.get('/user/get/id', this.doGetUserById);
        app.get('/user/get/phone', this.doGetUserByPhone);
    },
